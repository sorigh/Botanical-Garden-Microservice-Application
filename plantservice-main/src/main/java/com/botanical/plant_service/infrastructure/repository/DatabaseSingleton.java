...
public class DatabaseSingleton {
    ...
    private final String url = "jdbc:mysql://localhost:3306/plantservicedb";
    ...
    // Singleton thread-safe (simplu, nu sincronizat)
    ...
    public Connection getConnection() throws SQLException {
        // La fiecare apel, deschidem o conexiune nouă
